 ...
 */
@Sharable
public class BinaryWebsocketDecoder extends
		MessageToMessageDecoder<BinaryWebSocketFrame>
{
	...
	@Override
	protected void decode(ChannelHandlerContext ctx, BinaryWebSocketFrame frame,
			List<Object> out) throws Exception
	{
		...
		byte[] json = frame.content().array();
		LOG.debug("BinaryWebsocketDecoder  {}",json); 
