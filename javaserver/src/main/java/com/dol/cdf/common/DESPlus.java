...
public class DESPlus {
	...
	private static String strDefaultKey = "ssjjcrazypet";
	...
	public static void main(String[] args) throws Exception {
		DESPlus dwdesPlus = new DESPlus("dwcrazypet");
		DESPlus ssjjdesPlus = new DESPlus("ssjjcrazypet");
		int j = 0;
		for (int i = 0; i < 10000; i++) {
			String encrypt = dwdesPlus.encrypt(i+"");
			long l = System.currentTimeMillis();
			try {
//				System.out.println(encrypt);
				
				String decrypt = ssjjdesPlus.decrypt(encrypt);
...
//		System.out.println(encrypt);
//		String decrypt = desPlus.decrypt("aeb1edf845a11357");
//		System.out.println(decrypt);
	}
